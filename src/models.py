...
# LLM généralistes (génération contrainte vLLM).
MODELS = {
    # display_name        : hf_model_id                              # vérifié 2026-06-15 | taille
    "Qwen3-4B"  : "Qwen/Qwen3-4B",    # texte pur, instruct, public
    "Qwen3-1.7B": "Qwen/Qwen3-1.7B",  # texte pur, instruct, public
